...
router.get('/ultimas/:id_user', function(req, res, next) {
	...
	if (env == 'dev') {
		...
		hd_percentage,
		ram_percentage,
		FORMAT(log_time,'HH:mm:ss') as momento_grafico
		from tb_computer_log
		INNER JOIN tb_equipment on fk_equipment = id_equipment
...
router.get('/tempo-real/:id_user', function(req, res, next) {
